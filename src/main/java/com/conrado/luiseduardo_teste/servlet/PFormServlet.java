 ...
 * @author Conrado
 */
@WebServlet(name = "PFormServlet", urlPatterns = {"/passageiros/novo", "/passageiros/editar"})
public class PFormServlet extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        request.getRequestDispatcher("/WEB-INF/jsp/p-form-template.jsp").forward(request, response);
    }
}    